...
const structure = [
  ...
  // { id: 7, label: 'Library', link: 'https://samptechnologies.com/templates', icon: <LibraryIcon /> },
  // { id: 8, label: 'Support', link: 'https://samptechnologies.com/forum/', icon: <SupportIcon /> },
  // { id: 9, label: 'FAQ', link: 'https://samptechnologies.com/forum/', icon: <FAQIcon />},
  // { id: 10, type: 'divider' },
